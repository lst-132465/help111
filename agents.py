    ...
    class SimpleRetriever:
        ...
        def get_relevant_documents(self, query):
            ...
            for doc in self.docs:
                ...
                scored.append((-score, doc))  # 负号实现降序
            
            scored.sort()
            top3 = [t[1] for t in scored[:3]]
            # 构造和Chroma完全一致的返回对象
            return [type('Doc', (), {'page_content': text})() for text in top3]
